...
//	public static  String WEB_ROOT = "http://42.121.6.154/";
	...
	public static String URL_QUERY_STROE_ALL_NEWSPAPER = WEB_ROOT + "index/papershop.action?token=myadmin&resultType=json&currentPage=";
	...
	public static String URL_QUERY_LIST_ORDER_NEWS_SINGLE=WEB_ROOT+"newslinkshop!order.action?token=myadmin&nid=";
	...
	public static String URL_QUERY_LIST__NEWSPAPERSORDER=WEB_ROOT+"index/movieshop!order.action?token=myadmin&resultType=json&type=1&currentPage=";//已经订阅的电影
	...
	public static String URL_QUERY_SOFT_RECOMMDE = WEB_ROOT + "index/softshop.action?token=myadmin&resultType=json&type=1&currentPage="; //软件推荐
